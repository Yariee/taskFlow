...
import { AlertCircle, CheckCircle, Plus, Trash2, Edit2, LogOut } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-md">
          <h1 className="text-3xl font-bold text-gray-800 mb-6 text-center">TaskFlow</h1>
          ...
          <form onSubmit={handleTaskSubmit} className="space-y-4 mb-6">
            ...
            <div className="flex gap-4">
              ...
              <select
                ...
                onChange={(e) => setTaskForm({ ...taskForm, category_id: e.target.value || null })}
                className="px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
              >
            ...
            >
              {editingTask ? <Edit2 className="w-5 h-5 mr-2" /> : <Plus className="w-5 h-5 mr-2" />}
